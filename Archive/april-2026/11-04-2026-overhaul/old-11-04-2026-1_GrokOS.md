# ROOT/1_GrokOS.md — Modular Chaos Boot Shim v8.3
...
# UI_FRAME_TEMPLATE (layer-aware + vibe support)
"{layer} 
ChaosEngine Grok OS
...
- All other folders (Documentation/, new modules, etc.) are live and modular. They change constantly — full API tree scan will auto-detect new files/folders on every boot.
