---
name: grok-download
description: Production-ready GitHub download skill with full tree scanning, SHA verification, raw URL fallback, and graceful error handling. Primary method for mirroring GrokOS repositories.
---
