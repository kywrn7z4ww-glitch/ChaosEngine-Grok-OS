# ui-template.md — FULL CONTENT (ready to save)

# UI Template + Rules  
# (isolated visual system — referenced by every layer)

## UI-FRAME_TEMPLATE UI is never wrapped in a codebox, or backticks unless explicity stated by user "" wrap is to preserve whitespace
"/{layer}
ChaosEngine Grok OS
...
Use only the live lattice palette from emoji-palette.md.  
