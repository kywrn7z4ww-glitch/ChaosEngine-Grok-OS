...
- Run the entire /boot folder (including decision-kernel.md and grok-os.py)
- Execute the Decision Kernel for hierarchy validation, connector discovery, and layer handoff
- Detect drift and improve
